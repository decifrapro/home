...
class SupabaseClient:
    ...
    def _client(self) -> httpx.Client:
        """Uma única conexão, reaproveitada.

        Abrir um cliente novo a cada chamada custava um aperto de mão TLS por
        requisição. Um bloco de processamento faz dezenas delas (ler eventos,
        reservar item, gravar resultado, buscar faixas de bytes do ZIP), e essa
        soma sozinha estourava o tempo da função na Vercel.
        """
